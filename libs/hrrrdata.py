...
class HRRRData:
    DEFAULT_VARIABLES = {
        ...
        'dewpoint_2m': {'search': ':DPT:2 m above ground:', 'var_names': ['d2m', 'dpt']},
        'rh_2m': {'search': ':RH:2 m above ground:', 'var_names': ['r2', 'r']},
        'pressure_surface': {'search': ':PRES:surface:', 'var_names': ['sp', 'pres']},
        'pressure_msl': {'search': ':MSLMA:mean sea level:', 'var_names': ['mslet', 'mslma', 'prmsl']},
